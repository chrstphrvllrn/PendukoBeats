...
const Drawer = ({ cart, setCart, setShow, isOpen, setIsOpen, toggleDrawer  }) => {
    ...
    return (
        <div className="relative">
            ...
            {/* Drawer */}
            <div
                className={`fixed top-0 right-0 w-full md:w-3/4 lg:w-1/2 h-full bg-white shadow-lg transform transition-transform duration-300 z-50 ${isOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}
            >
                <div className="p-4">
                    <h2 className="text-2xl font-bold text">Cart</h2>
                    {/* <p className="text-zinc-500 text-sm">This is the item inside the Cart</p> */}
