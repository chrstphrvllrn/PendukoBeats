        ...
        '>
            ...
            <div className='w-full h-full  py-14 px-8 sm:px-16 md:px-16  backdrop-blur-md'>
                ...
                <div className='w-full gap-9 flex flex-col items-start justify-center'>
                    ...
                    <h1 class="text-4xl 2xl:text-7xl text-white font-extrabold select-none">{HeroData.headline1}<br></br><span className='text-white font-normal'>{HeroData.headline2}</span></h1>
